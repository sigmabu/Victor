...
namespace VMS23
{
    ...
    public struct tUdpSendData
    {
        ...
        public int iCmd;           //Command Number        : 1=Recipe 변경,  2=Auto모드 전환,  3=InRail Orient 검사,  4=L-Talbe Orient 검사,  5=R-Talble Orient 검사, 6=InRail BCR 검사, 7=L-table_rpm BCR 검사, 8=R-table_rpm BCR 검사, 99=Alive Check
    ...
    public class CUdpSocket : SingleTone<CUdpSocket>
    {
        ...
        private void SaveLog(string msg)
        {
            ...
            string sPath = CGvar.PATH_LOG + dtNow.Year.ToString("0000") + "\\" + dtNow.Month.ToString("00") + "\\" + dtNow.Day.ToString("00") + "\\UDP\\";
            string sLine = "";
