...
namespace VMS23
{
    ...
    class CIV2Ctrl
    {
        ...
        public CIV2Ctrl(int nIdx = 0)
        {
            ...
            m_log.SetFileName(@"D:\Log_Trace\IV2", sPath);
        ...
        private void OnClientConnectFunction(IAsyncResult ar)
        {
            ...
            m_log.Write($"---- Client connect success ID:{socket.nID}, sName:{socket.sName}");
        }
        ...
        private void OnClientDisconnectFunction(IAsyncResult ar)
        {
            ...
            m_log.Write($"**** Client Disconnect ID:{socket.nID}, sName:{socket.sName}");
        }
        #endregion
